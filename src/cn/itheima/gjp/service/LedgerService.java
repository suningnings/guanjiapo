...
public class LedgerService {
    ...
    public Double queryTotalMonetByParent(String parent) {
        ...
        return ld.queryTotalMonetByParent(parent);
    }

    public Map<String, Double> quarySumMoneyBySort(String parent) {
        // TODO Auto-generated method stub
        List<Object[]>list=ld.quarySumMoneyBySort(parent);
        Map<String, Double> map=new HashMap<String, Double>();
        for (Object[] objects : list) {
            Double money=(Double) objects[0];
            System.out.println("sid money="+money);
